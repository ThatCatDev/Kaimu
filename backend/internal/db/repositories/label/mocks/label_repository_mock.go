...
// Source: internal/db/repositories/label/label_repository.go
//
// Generated by this command:
//
//	mockgen -source=internal/db/repositories/label/label_repository.go -destination=internal/db/repositories/label/mocks/label_repository_mock.go -package=mocks
//
...
import (
	...
	label "github.com/thatcatdev/pulse-backend/internal/db/repositories/label"
...
func (m *MockRepository) Create(ctx context.Context, arg1 *label.Label) error {
	m.ctrl.T.Helper()
...
func (m *MockRepository) GetByID(ctx context.Context, id uuid.UUID) (*label.Label, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetByID", ctx, id)
	ret0, _ := ret[0].(*label.Label)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockRepository) GetByIDs(ctx context.Context, ids []uuid.UUID) ([]*label.Label, error) {
	m.ctrl.T.Helper()
...
func (m *MockRepository) GetByName(ctx context.Context, projectID uuid.UUID, name string) (*label.Label, error) {
	m.ctrl.T.Helper()
...
func (m *MockRepository) GetByProjectID(ctx context.Context, projectID uuid.UUID) ([]*label.Label, error) {
	m.ctrl.T.Helper()
...
func (m *MockRepository) Update(ctx context.Context, arg1 *label.Label) error {
	m.ctrl.T.Helper()
