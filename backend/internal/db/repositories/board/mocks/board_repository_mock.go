...
func (m *MockRepository) GetByProjectID(ctx context.Context, projectID uuid.UUID) ([]*board.Board, error) {
	m.ctrl.T.Helper()
...
// GetDefaultByProjectID mocks base method.
func (m *MockRepository) GetDefaultByProjectID(ctx context.Context, projectID uuid.UUID) (*board.Board, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetDefaultByProjectID", ctx, projectID)
	ret0, _ := ret[0].(*board.Board)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetDefaultByProjectID indicates an expected call of GetDefaultByProjectID.
func (mr *MockRepositoryMockRecorder) GetDefaultByProjectID(ctx, projectID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
